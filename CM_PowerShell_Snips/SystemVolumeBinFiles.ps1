...
#>
# In windows 11 ver 24H2 - the Get-Volume command returns filesystem like this "FAT" since in the code you specified only "FAT32" it will not work. probebly it's better to change it to $_.FileSystemType -contains "FAT" with this change it worked for me.
$Volume = Get-Volume | Where-Object {$_.FileSystemType -contains "FAT" -and $_.DriveType -eq "Fixed"}
